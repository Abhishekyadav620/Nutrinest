        ...
        <div className="card p-3">
          ...
          <form onSubmit={submit} className="row g-3">
            ...
            <div className="col-12 text-end">
              <button type="button" className="btn btn-secondary me-2" onClick={onClose} style={{ minWidth: '120px' }}>Cancel</button>
              <button type="submit" className="btn btn-success edit-btn" style={{ minWidth: '120px' }}>Save changes</button>
            </div>
          </form>
        </div>
      </div>
